      ...
      <div className="bg-primary-fixed border-2 border-primary p-4" style={{ boxShadow: '4px 4px 0px var(--shadow-color)' }}>
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <h2 className="font-headline font-bold text-primary text-lg leading-tight">{notes.title}</h2>
          </div>
        </div>
      </div>
        ...
        <div className="p-4 bg-surface-container-lowest">
          ...
          {activeTab === 'summary' && (
            <div className="space-y-3">
              <p className="text-body-md text-on-surface leading-relaxed">{notes.summary}</p>
